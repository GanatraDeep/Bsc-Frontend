    ...
    <footer class="footer">
        <div class="footer-body">
            ...
            <div class="right-panel">
                ©
                <script>document.write(new Date().getFullYear())</script> Bsc Chaiwala, Made with
                ...
                </span> by <a href="https://divtech.in/">Div Tech</a>.
            </div>
        </div>
    </footer>
    <!-- Footer Section End -->
...
<script>
    async function fetchStockLowLevels() {
        Swal.fire({
            title: 'Fetching data...',
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/stock/low/${sessionStorage.getItem('franchise')}/${sessionStorage.getItem('branch')}`, {
                method: 'GET',
                headers: {
                    ...
                    <a href="#" class="iq-sub-card">
                        <div class="d-flex align-items-center">
                            <div class="ms-3 w-100">
                                <h6 class="mb-0 ">0 Notification To Show</h6>
            ...
            data.forEach(stock => {
                ...
                <a href="#" class="iq-sub-card">
                    <div class="d-flex align-items-center">
                        <div class="ms-3 w-100">
                            <h6 class="mb-0 ">${stock.raw_material_name}</h6>
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="mb-0">${parseFloat(stock.shortage).toFixed(2)} / ${stock.unit_name}</p>
                                <small class="float-end font-size-12">Below Levels</small>
                            </div>
                        </div>
                    </div>
                </a>`;

                $("#notificationBody").append(row);
            });
