<div class="position-relative">
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
            <div class="container-fluid navbar-inner">
                <a href="#" class="navbar-brand text-end">
                    <!--Logo start-->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto align-items-center navbar-list mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <div class="sub-drop dropdown-menu dropdown-menu-end p-0"
                                ...
                                <div class="card shadow-none m-0">
                                    <div class="card-header d-flex justify-content-between bg-secondary mx-0 px-4">
                                        <div class="header-title">
                                            <h5 class="mb-0 text-white">All Notifications</h5>
                                        </div>
                                    </div>
                                    <div class="card-body p-0" id="notificationBody">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link" id="mail-drop2" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown"
                                ...
                                <div class="caption ms-3 d-none d-md-block ">
                                    ...
                                    <p class="mb-0 caption-sub-title">
                                        <script>
                                            document.write(sessionStorage.getItem('role'));
                                        </script>
                                    </p>
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item"
                                        href="#">Privacy Setting</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="#" onclick="sessionStorage.clear();window.location.replace('../index.php');">Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
