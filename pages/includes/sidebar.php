        ...
        <a href="../../dashboard/index.html" class="navbar-brand">
            ...
            <div class="logo">
                <svg width="40" height="43" viewBox="0 0 40 43" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Text -->
                    <text x="50%" y="55%" text-anchor="middle" fill="#ef9355" font-family="Arial, sans-serif"
                        font-size="28" font-weight="bold">
                        B
                    </text>
                </svg>
            </div>
            <div class="logo-hover text-center">
                <img src="../assets/images/logo.png" class="img-fluid w-50" alt="img4">
            </div>
            ...
            <ul class="navbar-nav iq-main-menu">
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Raw Materials</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item sub-nav">
                    <a class="nav-link <?php if($page == "Raw Material Management"){echo "active";}else{echo "";}; ?>" aria-current="page" href="./dashboard.php">
                        <i class="icon">
                ...
                <li class="nav-item sub-nav">
                    <a class="nav-link <?php if($page == "Raw Material Purchase"){echo "active";}else{echo "";}; ?>" aria-current="page" href="./raw_material_purchase.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                                    d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <li class="nav-item sub-nav">
                    <a class="nav-link <?php if($page == "Stock Level"){echo "active";}else{echo "";}; ?>" aria-current="page" href="./stock_level.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                                    d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Items Management</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item sub-nav">
                    <a class="nav-link <?php if($page == "Item Category Management"){echo "active";}else{echo "";}; ?>" aria-current="page" href="./item_category.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item sub-nav">
                    <a class="nav-link <?php if($page == "Item Management"){echo "active";}else{echo "";}; ?>" aria-current="page" href="./item_management.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M11.9912 18.6215L5.49945 21.864C5.00921 22.1302 4.39768 21.9525 4.12348 21.4643C4.0434 21.3108 4.00106 21.1402 4 20.9668V13.7087C4 14.4283 4.40573 14.8725 5.47299 15.37L11.9912 18.6215Z" fill="currentColor"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.89526 2H15.0695C17.7773 2 19.9735 3.06605 20 5.79337V20.9668C19.9989 21.1374 19.9565 21.3051 19.8765 21.4554C19.7479 21.7007 19.5259 21.8827 19.2615 21.9598C18.997 22.0368 18.7128 22.0023 18.4741 21.8641L11.9912 18.6215L5.47299 15.3701C4.40573 14.8726 4 14.4284 4 13.7088V5.79337C4 3.06605 6.19625 2 8.89526 2ZM8.22492 9.62227H15.7486C16.1822 9.62227 16.5336 9.26828 16.5336 8.83162C16.5336 8.39495 16.1822 8.04096 15.7486 8.04096H8.22492C7.79137 8.04096 7.43991 8.39495 7.43991 8.83162C7.43991 9.26828 7.79137 9.62227 8.22492 9.62227Z" fill="currentColor"></path>
                ...
                <li class="nav-item sub-nav">
                    <a class="nav-link <?php if($page == "Recipe Management"){echo "active";}else{echo "";}; ?>" aria-current="page" href="./recipe_management.php">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M11.9912 18.6215L5.49945 21.864C5.00921 22.1302 4.39768 21.9525 4.12348 21.4643C4.0434 21.3108 4.00106 21.1402 4 20.9668V13.7087C4 14.4283 4.40573 14.8725 5.47299 15.37L11.9912 18.6215Z" fill="currentColor"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.89526 2H15.0695C17.7773 2 19.9735 3.06605 20 5.79337V20.9668C19.9989 21.1374 19.9565 21.3051 19.8765 21.4554C19.7479 21.7007 19.5259 21.8827 19.2615 21.9598C18.997 22.0368 18.7128 22.0023 18.4741 21.8641L11.9912 18.6215L5.47299 15.3701C4.40573 14.8726 4 14.4284 4 13.7088V5.79337C4 3.06605 6.19625 2 8.89526 2ZM8.22492 9.62227H15.7486C16.1822 9.62227 16.5336 9.26828 16.5336 8.83162C16.5336 8.39495 16.1822 8.04096 15.7486 8.04096H8.22492C7.79137 8.04096 7.43991 8.39495 7.43991 8.83162C7.43991 9.26828 7.79137 9.62227 8.22492 9.62227Z" fill="currentColor"></path>
                        ...
                        <span class="item-name">Receipe</span>
                    </a>
                </li>
            <!-- Sidebar Menu End -->
        </div>
